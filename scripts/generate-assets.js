 ...
 * `assets/brand/logo/` + `assets/brand/tokens/` (see assets/brand/README.md:
...
const LOGO_SVG_DIR = path.join(ROOT, "assets/brand/logo");
...
function buildFittedSymbolSvg({ canvas, geometry, bbox, targetRadius, fillColor, dotColor }) {
  ...
  <!-- Bumelerze mark, fitted from assets/brand/logo/bumelerze-symbol-color.svg. -->
